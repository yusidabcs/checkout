...
<head>
    ...
    {{HTML::style('packages/yusidabcs/checkout/css/nprogress.css')}}
        ...
        <div class="container container-narrow">
            <div class="row-fluid">
                ...
                <div style="text-align: center;">
                    <small>Copyright © {{date('Y')}} 
                        <span style="font-weight: bold;">{{$kontak->nama}}</span>. All Rights Reserved. Powered by 
                    </small>
                    <a href="http://www.jarvis-store.com" style="font-size: 12px;">Jarvis Store</a>
                </div>
                <br><br>     
            </div><!--/.fluid-container-->
        </div>
...
{{HTML::script("packages/yusidabcs/checkout/js/nprogress.js")}}
